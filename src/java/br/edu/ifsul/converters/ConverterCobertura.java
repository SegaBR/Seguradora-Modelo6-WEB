 ...
 * @author sega
 */
@Named(value="converterCobertura")
@RequestScoped
public class ConverterCobertura implements Serializable, Converter{
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
       ...
       return em.find(Cobertura.class,Integer.parseInt(value));
    }
