 ...
 * @author sega
 */
@Named(value="converterSinistro")
@RequestScoped
public class ConverterSinistro implements Serializable, Converter{
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
       ...
       return em.find(Sinistro.class,Integer.parseInt(value));
    }
